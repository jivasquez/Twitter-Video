...
setup(name='twitter_video',
      ...
      dependency_links = ["https://bitbucket.org/wkornewald/django-nonrel", "hg+https://bitbucket.org/wkornewald/djangotoolbox", "git+https://github.com/django-nonrel/mongodb-engine" ],
      )